...
class GameRecognitionModule(dspy.Module):
    ...
    def forward(self, image_paths: List[str]) -> BoardGameList:
        ...
        result = self.recognize_games(image_paths=image_paths, tools=[bgg_tool])
        return result.games
...
def main():
    ...
    gemini = dspy.LM(model="gemini/gemini-1.5-pro", api_key=os.getenv("GEMINI_API_KEY"))
    ...
    for image_file in image_files:
        ...
        try:
            ...
            recognized_games = recognizer.forward(image_paths=[image])
